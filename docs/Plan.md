...
**11. Заявка "Оплата по карте", значение поля "Год" прошлого периода**
...
**12. Заявка "Оплата по карте", значение поля "Год" далекого будущего периода**
...
**13. Заявка "Оплата по карте", значение поля "CVC/CVV" пусто**
...
**14. Заявка "Оплата по карте", значение поля "CVC/CVV" 1 цифра**
...
**15. Заявка "Оплата по карте", значение поля "CVC/CVV" 2 цифры**
...
**16. Заявка "Оплата по карте", значение поля "Владелец" оформлено в верхнем регистре**
...
**17. Заявка "Оплата по карте", значение поля "Владелец" через дефис**
...
**18. Заявка "Оплата по карте", значение поля "Владелец" пустое**
...
**19. Заявка "Оплата по карте", значение поля "Владелец" фамилия на латинице, имя отсуствует**
...
**20. Заявка "Оплата по карте", значение поля "Владелец" фамилия и имя на кирилице**
...
**22. Заявка "Оплата по карте", значение поля "Владелец" заполнено спец.символами**
